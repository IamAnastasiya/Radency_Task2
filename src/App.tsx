...
function App() {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <button className={classes['action-create']} onClick={openModalHandler}>Create note</button>
      <Table tableMode={'summary'}/>
      <button className={classes['archive-toggler']} onClick={archiveVisibilityHandler}>{archiveBtnText}</button>
